  ...
  var se = /*#__PURE__*/function () {
    ...
    return _createClass(se, [{
        ...
        if (n.length === s.length) {
          ...
          try {
            for (_iterator.s(); !(_step = _iterator.n()).done;) {
              var _e0 = _step.value;
              this.rules.other.tableAlignRight.test(_e0) ? i.align.push("right") : this.rules.other.tableAlignCenter.test(_e0) ? i.align.push("center") : this.rules.other.tableAlignLeft.test(_e0) ? i.align.push("left") : i.align.push(null);
            }
          } catch (err) {
            _iterator.e(err);
          } finally {
          ...
          try {
            for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
              var _e1 = _step2.value;
              i.rows.push(ee(_e1, i.header.length).map(function (e, t) {
                return {
                  text: e,
      ...
      value: function link(e) {
        ...
        if (t) {
          var _e11 = t[2].trim();
          if (!this.options.pedantic && this.rules.other.startAngleBracket.test(_e11)) {
            if (!this.rules.other.endAngleBracket.test(_e11)) return;
            var _t8 = te(_e11.slice(0, -1), "\\");
            if ((_e11.length - _t8.length) % 2 == 0) return;
          } else {
            var _e12 = function (e, t) {
            ...
            if (_e12 > -1) {
              var _n8 = (0 === t[0].indexOf("!") ? 5 : 4) + t[1].length + _e12;
              t[2] = t[2].substring(0, _e12), t[0] = t[0].substring(0, _n8).trim(), t[3] = "";
            }
          }
          var _n9 = t[2],
            _s6 = "";
          if (this.options.pedantic) {
            var _e13 = this.rules.other.pedanticHrefTitle.exec(_n9);
            _e13 && (_n9 = _e13[1], _s6 = _e13[3]);
          } else _s6 = t[3] ? t[3].slice(1, -1) : "";
          return _n9 = _n9.trim(), this.rules.other.startAngleBracket.test(_n9) && (_n9 = this.options.pedantic && !this.rules.other.endAngleBracket.test(_e11) ? _n9.slice(1) : _n9.slice(1, -1)), ne(t, {
      ...
      value: function reflink(e, t) {
        ...
        if ((n = this.rules.inline.reflink.exec(e)) || (n = this.rules.inline.nolink.exec(e))) {
          var _e14 = t[(n[2] || n[1]).replace(this.rules.other.multipleSpaceGlobal, " ").toLowerCase()];
          if (!_e14) {
            var _e15 = n[0].charAt(0);
            return {
              type: "text",
              raw: _e15,
              text: _e15
          ...
          return ne(n, _e14, n[0], this.lexer, this.rules);
        }
      }
    }, {
      key: "emStrong",
        ...
        if (!(s[1] || s[2] || "") || !n || this.rules.inline.punctuation.exec(n)) {
          ...
          for (_a3.lastIndex = 0, t = t.slice(-1 * e.length + _n0); null != (s = _a3.exec(t));) {
            ...
            var _t9 = _toConsumableArray(s[0])[0].length,
              _a4 = e.slice(0, _n0 + s.index + _t9 + _i6);
            if (Math.min(_n0, _i6) % 2) {
              var _e16 = _a4.slice(1, -1);
              return {
                type: "em",
                raw: _a4,
                text: _e16,
                tokens: this.lexer.inlineTokens(_e16)
              };
            }
      ...
      value: function codespan(e) {
        ...
        if (t) {
          var _e17 = t[2].replace(this.rules.other.newLineCharGlobal, " ");
          var _n1 = this.rules.other.nonSpaceChar.test(_e17),
            _s7 = this.rules.other.startingSpaceChar.test(_e17) && this.rules.other.endingSpaceChar.test(_e17);
          return _n1 && _s7 && (_e17 = _e17.substring(1, _e17.length - 1)), {
            type: "codespan",
            raw: t[0],
            text: _e17
          };
      ...
      value: function autolink(e) {
        ...
        if (t) {
          var _e18, _n10;
          return "@" === t[2] ? (_e18 = t[1], _n10 = "mailto:" + _e18) : (_e18 = t[1], _n10 = _e18), {
            type: "link",
            raw: t[0],
            text: _e18,
            href: _n10,
      ...
      value: function url(e) {
        ...
        if (t = this.rules.inline.url.exec(e)) {
          var _e19, _n11;
          if ("@" === t[2]) _e19 = t[0], _n11 = "mailto:" + _e19;else {
            var _s8;
            do {
            ...
            _e19 = t[0], _n11 = "www." === t[1] ? "http://" + t[0] : t[0];
          }
          return {
            type: "link",
            raw: t[0],
      ...
      value: function inlineText(e) {
        ...
        if (t) {
          var _e20 = this.lexer.state.inRawBlock;
          return {
            type: "text",
            raw: t[0],
            text: t[0],
  ...
  var re = /*#__PURE__*/function () {
    ...
    return _createClass(re, [{
      ...
      value: function lex(e) {
        ...
        for (var _e21 = 0; _e21 < this.inlineQueue.length; _e21++) {
          var _t0 = this.inlineQueue[_e21];
          this.inlineTokens(_t0.src, _t0.tokens);
        }
      ...
      value: function blockTokens(e) {
        ...
        var _loop = function _loop() {
            ...
            if (s = _this3.tokenizer.space(e)) {
              ...
              var _n12 = t.at(-1);
              1 === s.raw.length && void 0 !== _n12 ? _n12.raw += "\n" : t.push(s);
              return 0; // continue
            }
            if (s = _this3.tokenizer.code(e)) {
              e = e.substring(s.raw.length);
              var _n13 = t.at(-1);
              "paragraph" === (_n13 === null || _n13 === void 0 ? void 0 : _n13.type) || "text" === (_n13 === null || _n13 === void 0 ? void 0 : _n13.type) ? (_n13.raw += "\n" + s.raw, _n13.text += "\n" + s.text, _this3.inlineQueue.at(-1).src = _n13.text) : t.push(s);
              return 0; // continue
            }
            ...
            if (s = _this3.tokenizer.def(e)) {
              e = e.substring(s.raw.length);
              var _n14 = t.at(-1);
              "paragraph" === (_n14 === null || _n14 === void 0 ? void 0 : _n14.type) || "text" === (_n14 === null || _n14 === void 0 ? void 0 : _n14.type) ? (_n14.raw += "\n" + s.raw, _n14.text += "\n" + s.raw, _this3.inlineQueue.at(-1).src = _n14.text) : _this3.tokens.links[s.tag] || (_this3.tokens.links[s.tag] = {
                href: s.href,
                title: s.title
              });
              return 0; // continue
            ...
            if ((_this3$options$extens2 = _this3.options.extensions) !== null && _this3$options$extens2 !== void 0 && _this3$options$extens2.startBlock) {
              ...
              _this3.options.extensions.startBlock.forEach(function (e) {
                _s9 = e.call({
                  lexer: _this3
                }, _n15), "number" == typeof _s9 && _s9 >= 0 && (_t1 = Math.min(_t1, _s9));
              }), _t1 < 1 / 0 && _t1 >= 0 && (r = e.substring(0, _t1 + 1));
            }
            if (_this3.state.top && (s = _this3.tokenizer.paragraph(r))) {
              ...
              e = e.substring(s.raw.length);
              var _n16 = t.at(-1);
              "text" === (_n16 === null || _n16 === void 0 ? void 0 : _n16.type) ? (_n16.raw += "\n" + s.raw, _n16.text += "\n" + s.text, _this3.inlineQueue.pop(), _this3.inlineQueue.at(-1).src = _n16.text) : t.push(s);
            } else if (e) {
              var _t10 = "Infinite loop on byte: " + e.charCodeAt(0);
              if (_this3.options.silent) {
                console.error(_t10);
                return 1; // break
              }
              throw new Error(_t10);
            }
          },
          _ret;
      ...
      value: function inlineTokens(e) {
        ...
        if (this.tokens.links) {
          var _e22 = Object.keys(this.tokens.links);
          if (_e22.length > 0) for (; null != (s = this.tokenizer.rules.inline.reflinkSearch.exec(n));) _e22.includes(s[0].slice(s[0].lastIndexOf("[") + 1, -1)) && (n = n.slice(0, s.index) + "[" + "a".repeat(s[0].length - 2) + "]" + n.slice(this.tokenizer.rules.inline.reflinkSearch.lastIndex));
        }
        ...
        var _loop2 = function _loop2() {
            ...
            if (s = _this4.tokenizer.reflink(e, _this4.tokens.links)) {
              e = e.substring(s.raw.length);
              var _n17 = t.at(-1);
              "text" === s.type && "text" === (_n17 === null || _n17 === void 0 ? void 0 : _n17.type) ? (_n17.raw += s.raw, _n17.text += s.text) : t.push(s);
              return 0; // continue
            }
            ...
            if ((_this4$options$extens2 = _this4.options.extensions) !== null && _this4$options$extens2 !== void 0 && _this4$options$extens2.startInline) {
              ...
              _this4.options.extensions.startInline.forEach(function (e) {
                _s0 = e.call({
                  lexer: _this4
                }, _n18), "number" == typeof _s0 && _s0 >= 0 && (_t11 = Math.min(_t11, _s0));
              }), _t11 < 1 / 0 && _t11 >= 0 && (l = e.substring(0, _t11 + 1));
            }
            if (s = _this4.tokenizer.inlineText(l)) {
              e = e.substring(s.raw.length), "_" !== s.raw.slice(-1) && (i = s.raw.slice(-1)), r = !0;
              var _n19 = t.at(-1);
              "text" === (_n19 === null || _n19 === void 0 ? void 0 : _n19.type) ? (_n19.raw += s.raw, _n19.text += s.text) : t.push(s);
            } else if (e) {
    ...
    return _createClass(ie, [{
      ...
      value: function list(e) {
        var t = e.ordered,
          n = e.start;
        var s = "";
        for (var _t13 = 0; _t13 < e.items.length; _t13++) {
          var _n20 = e.items[_t13];
          s += this.listitem(_n20);
        }
        var r = t ? "ol" : "ul";
      ...
      value: function listitem(e) {
        ...
        if (e.task) {
          var _e$tokens$;
          var _n21 = this.checkbox({
            checked: !!e.checked
          });
          e.loose ? "paragraph" === ((_e$tokens$ = e.tokens[0]) === null || _e$tokens$ === void 0 ? void 0 : _e$tokens$.type) ? (e.tokens[0].text = _n21 + " " + e.tokens[0].text, e.tokens[0].tokens && e.tokens[0].tokens.length > 0 && "text" === e.tokens[0].tokens[0].type && (e.tokens[0].tokens[0].text = _n21 + " " + W(e.tokens[0].tokens[0].text), e.tokens[0].tokens[0].escaped = !0)) : e.tokens.unshift({
            type: "text",
            raw: _n21 + " ",
            text: _n21 + " ",
            escaped: !0
      ...
      value: function table(e) {
        var t = "",
          n = "";
        for (var _t14 = 0; _t14 < e.header.length; _t14++) n += this.tablecell(e.header[_t14]);
        t += this.tablerow({
          text: n
        });
        var s = "";
        for (var _t15 = 0; _t15 < e.rows.length; _t15++) {
          var _r5 = e.rows[_t15];
          n = "";
          for (var _e23 = 0; _e23 < _r5.length; _e23++) n += this.tablecell(_r5[_e23]);
          s += this.tablerow({
            text: n
          });
        }
  ...
  var oe = /*#__PURE__*/function () {
    ...
    return _createClass(oe, [{
      ...
      value: function parse(e) {
        ...
        var n = "";
        for (var _s1 = 0; _s1 < e.length; _s1++) {
          ...
          if ((_this$options$extensi = this.options.extensions) !== null && _this$options$extensi !== void 0 && (_this$options$extensi = _this$options$extensi.renderers) !== null && _this$options$extensi !== void 0 && _this$options$extensi[_r6.type]) {
            var _e24 = _r6,
              _t16 = this.options.extensions.renderers[_e24.type].call({
                parser: this
              }, _e24);
            if (!1 !== _t16 || !["space", "hr", "heading", "code", "table", "blockquote", "list", "html", "paragraph", "text"].includes(_e24.type)) {
              n += _t16 || "";
              continue;
            }
          }
          ...
          switch (_i8.type) {
            ...
            case "text":
              {
                ...
                for (; _s1 + 1 < e.length && "text" === e[_s1 + 1].type;) _r7 = e[++_s1], _l7 += "\n" + this.renderer.text(_r7);
            ...
            default:
              {
                var _e25 = 'Token with "' + _i8.type + '" type was not found.';
                if (this.options.silent) return console.error(_e25), "";
      ...
      value: function parseInline(e) {
        ...
        for (var _s10 = 0; _s10 < e.length; _s10++) {
          ...
          if ((_this$options$extensi2 = this.options.extensions) !== null && _this$options$extensi2 !== void 0 && (_this$options$extensi2 = _this$options$extensi2.renderers) !== null && _this$options$extensi2 !== void 0 && _this$options$extensi2[_r8.type]) {
            var _e26 = this.options.extensions.renderers[_r8.type].call({
              parser: this
            }, _r8);
            if (!1 !== _e26 || !["escape", "html", "link", "image", "strong", "em", "codespan", "br", "del", "text"].includes(_r8.type)) {
              n += _e26 || "";
              continue;
            }
          }
          ...
          switch (_i9.type) {
            ...
            default:
              {
                var _e27 = 'Token with "' + _i9.type + '" type was not found.';
          ...
          var _loop3 = function _loop3() {
            ...
            switch (n = n.concat(t.call(_this5, s)), s.type) {
              case "table":
                {
                  var _e28 = s;
                  var _iterator4 = _createForOfIteratorHelper(_e28.header),
                    _step4;
                  try {
                    for (_iterator4.s(); !(_step4 = _iterator4.n()).done;) {
                      var _s11 = _step4.value;
                      n = n.concat(_this5.walkTokens(_s11.tokens, t));
                    }
                  } catch (err) {
                    _iterator4.e(err);
                  } finally {
                  ...
                  var _iterator5 = _createForOfIteratorHelper(_e28.rows),
                    _step5;
                  try {
                    for (_iterator5.s(); !(_step5 = _iterator5.n()).done;) {
                      var _s12 = _step5.value;
                      var _iterator6 = _createForOfIteratorHelper(_s12),
                        _step6;
                      try {
                        for (_iterator6.s(); !(_step6 = _iterator6.n()).done;) {
                          var _e29 = _step6.value;
                          n = n.concat(_this5.walkTokens(_e29.tokens, t));
                        }
                      } catch (err) {
                        _iterator6.e(err);
                      } finally {
              ...
              case "list":
                {
                  var _e30 = s;
                  n = n.concat(_this5.walkTokens(_e30.items, t));
                  break;
                }
              default:
                {
                  ...
                  var _e31 = s;
                  (_this5$defaults$exten = _this5.defaults.extensions) !== null && _this5$defaults$exten !== void 0 && (_this5$defaults$exten = _this5$defaults$exten.childTokens) !== null && _this5$defaults$exten !== void 0 && _this5$defaults$exten[_e31.type] ? _this5.defaults.extensions.childTokens[_e31.type].forEach(function (s) {
                    var r = _e31[s].flat(1 / 0);
                    n = n.concat(_this5.walkTokens(r, t));
                  }) : _e31.tokens && (n = n.concat(_this5.walkTokens(_e31.tokens, t)));
                }
            }
          };
      ...
      value: function use() {
        ...
        return e.forEach(function (e) {
          ...
          if (n.async = _this6.defaults.async || n.async || !1, e.extensions && (e.extensions.forEach(function (e) {
            ...
            if ("renderer" in e) {
              var _n22 = t.renderers[e.name];
              t.renderers[e.name] = _n22 ? function () {
                for (var _len2 = arguments.length, t = new Array(_len2), _key2 = 0; _key2 < _len2; _key2++) {
                  t[_key2] = arguments[_key2];
                }
                var s = e.renderer.apply(this, t);
                return !1 === s && (s = _n22.apply(this, t)), s;
              } : e.renderer;
            }
            if ("tokenizer" in e) {
              if (!e.level || "block" !== e.level && "inline" !== e.level) throw new Error("extension level must be 'block' or 'inline'");
              var _n23 = t[e.level];
              _n23 ? _n23.unshift(e.tokenizer) : t[e.level] = [e.tokenizer], e.start && ("block" === e.level ? t.startBlock ? t.startBlock.push(e.start) : t.startBlock = [e.start] : "inline" === e.level && (t.startInline ? t.startInline.push(e.start) : t.startInline = [e.start]));
            }
            "childTokens" in e && e.childTokens && (t.childTokens[e.name] = e.childTokens);
          }), n.extensions = t), e.renderer) {
            var _t17 = _this6.defaults.renderer || new ie(_this6.defaults);
            var _loop4 = function _loop4() {
              if (!(_n24 in _t17)) throw new Error("renderer '".concat(_n24, "' does not exist"));
              if (["options", "parser"].includes(_n24)) return 1; // continue
              var s = _n24,
                r = e.renderer[s],
                i = _t17[s];
              _t17[s] = function () {
                ...
                var n = r.apply(_t17, e);
                return !1 === n && (n = i.apply(_t17, e)), n || "";
              };
            };
            for (var _n24 in e.renderer) {
              if (_loop4()) continue;
            }
            n.renderer = _t17;
          }
          if (e.tokenizer) {
            var _t18 = _this6.defaults.tokenizer || new se(_this6.defaults);
            var _loop5 = function _loop5() {
              if (!(_n25 in _t18)) throw new Error("tokenizer '".concat(_n25, "' does not exist"));
              if (["options", "rules", "lexer"].includes(_n25)) return 1; // continue
              var s = _n25,
                r = e.tokenizer[s],
                i = _t18[s];
              _t18[s] = function () {
                ...
                var n = r.apply(_t18, e);
                return !1 === n && (n = i.apply(_t18, e)), n;
              };
            };
            for (var _n25 in e.tokenizer) {
              if (_loop5()) continue;
            }
            n.tokenizer = _t18;
          }
          if (e.hooks) {
            var _t19 = _this6.defaults.hooks || new ae();
            var _loop6 = function _loop6() {
              if (!(_n26 in _t19)) throw new Error("hook '".concat(_n26, "' does not exist"));
              if (["options", "block"].includes(_n26)) return 1; // continue
              var s = _n26,
                r = e.hooks[s],
                i = _t19[s];
              ae.passThroughHooks.has(_n26) ? _t19[s] = function (e) {
                if (_this6.defaults.async) return Promise.resolve(r.call(_t19, e)).then(function (e) {
                  return i.call(_t19, e);
                });
                var n = r.call(_t19, e);
                return i.call(_t19, n);
              } : _t19[s] = function () {
            ...
            for (var _n26 in e.hooks) {
              if (_loop6()) continue;
            }
            n.hooks = _t19;
          }
          if (e.walkTokens) {
            var _t20 = _this6.defaults.walkTokens,
              _s13 = e.walkTokens;
            n.walkTokens = function (e) {
              var n = [];
              return n.push(_s13.call(this, e)), _t20 && (n = n.concat(_t20.call(this, e))), n;
            };
          }
      ...
      value: function parseMarkdown(e) {
        ...
        return function (t, n) {
          ...
          try {
            ...
            var _e32 = l(t, r);
            r.hooks && (_e32 = r.hooks.processAllTokens(_e32)), r.walkTokens && _this7.walkTokens(_e32, r.walkTokens);
            var _n27 = o(_e32, r);
            return r.hooks && (_n27 = r.hooks.postprocess(_n27)), _n27;
          } catch (e) {
            return i(e);
          }
        };
      ...
      value: function onError(e, t) {
        return function (n) {
          if (n.message += "\nPlease report this to https://github.com/markedjs/marked.", e) {
            var _e33 = "<p>An error occurred:</p><pre>" + W(n.message + "", !0) + "</pre>";
            return t ? Promise.resolve(_e33) : _e33;
          }
...
/******/ 	var __webpack_exports__ = __webpack_require__("./src/assets/js/marked.min.js");
/******/ 	
